...
const Signup = () => {
  ...
  return (
    <main className="mx-auto max-w-md px-6 py-16">
      <h1 className="mb-2 font-display text-3xl text-slate-50">
        Start issuing certificates
      </h1>
      <p className="mb-8 text-sm text-slate-400">
        Create your organisation — you'll be its owner and can invite your team
        afterwards.
      </p>
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-slate-500">
            Use your work domain — colleagues who sign up with the same domain
            join this organisation automatically instead of creating a
            duplicate.
          </p>
        </div>
        <div>
